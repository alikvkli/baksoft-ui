...
const SelectButton = forwardRef<HTMLButtonElement, ISelectButton>(({ className, selected, id, prefixIcon, suffixIcon, buttonText, ...props }, ref) => {
  ...
  return (
    <button ref={ref} {...props} className={cn(
      ...
      <input type="checkbox" checked={selected} readOnly id={id} className="absolute opacity-0 cursor-pointer h-0 w-0 peer" />
