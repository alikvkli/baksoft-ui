  ...
  return (
    <main>
      ...
      <div className="fixed inset-0 z-30 transition-all transform">
        ...
        <div className={classNames("absolute top-0 right-0 h-full w-3/4 bg-white shadow-md z-40 transition-transform transform", {
      ...
      <div className="flex h-screen justify-between">
        <div className="flex flex-col justify-center shrink-0 items-center w-[40%] max-lg:w-full  max-sm:h-fit max-md:px-4 pt-4">
          <div className="flex flex-col justify-center w-[380px] max-sm:w-full gap-4">
            ...
            <Link className="font-normal text-xs text-[#808080] flex justify-end pr-2" to="/sifremi-unuttum">Şifremi unuttum</Link>
